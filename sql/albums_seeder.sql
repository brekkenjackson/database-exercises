...
VALUES
    ...
    ('The Eagles', 'Hotel California', 1976, 'Rock, Soft rock, Folk rock', 31.8),
    ...
    ('Led Zeppelin', 'Led Zeppelin IV', 1971, 'Hard rock, Heavy metal, Folk', 30.4),
    ('Michael Jackson', 'Bad', 1987, 'Pop, Funk, Rock', 21.1),
    ('Meat Loaf', 'Bat Out of Hell', 1977, 'Hard rock, Progressive rock', 22.0),
    ...
    ('Metallica', 'Metallica', 1991, 'Thrash metal, Heavy metal', 22.7),
    ...
    ('Bruce Springsteen', 'Born in the U.S.A.', 1984, 'Rock', 22),
    ('ABBA', 'Gold: Greatest Hits', 1992, 'Pop, disco', 21.6),
    ('Dire Straits', 'Brothers in Arms', 1985, 'Rock, Pop', 21.1),
    ('Santana', 'Supernatural', 1999, 'Rock', 20.8),
    ...
    ('Michael Jackson', 'Dangerous', 1991, 'Rock, Funk, Pop', 17.0),
