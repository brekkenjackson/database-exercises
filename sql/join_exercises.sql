# emp_no is the FK that matches to employees
# dept_no is the FK that matches to departments
...
SELECT CONCAT(e.first_name, ' ', e.last_name) as emp_name, d.dept_name, CONCAT(e2.first_name, ' ', e2.last_name) as mngr_name
FROM employees AS e
JOIN dept_emp AS de ON e.emp_no = de.emp_no
